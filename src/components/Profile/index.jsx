...
const UserProfile = () => {
    ...
    const handleSubmit = async () => {
        ...
        await axiosData(accessToken).put(`/api/user/update/${user.user_id}`,{
            ...user,
                ...
                {!showEdit ? (
                    ...
                    <div className="profile-info_edit">
                        <div className="profile-details">
                            <div className="profile-item">
                                <strong>Email:</strong>
                                <input value={editUser.email} onChange={(e) => seteditUser({
                                    ...editUser,
                            ...
                            <div className="profile-item">
                                <strong>Username:</strong>
                                <input value={editUser.name} onChange={(e) => seteditUser({
                                    ...editUser,
                                    name: e.target.value
                                })}/>
                            </div>
                            <div className="profile-item">
                                <strong>Birthday:</strong>
                                <input className="birthday" type="date" value={editUser.birthday} onChange={(e) => seteditUser({
                                    ...editUser,
                            ...
                            <div className="profile-item">
                                <strong>Gender:</strong>
                                <select name={editUser.gender || "Noshare"} onChange={(e) => seteditUser({
                                    ...editUser,
                            ...
                            <div className="profile-item">
                                <strong>Phone:</strong>
                                <input value={editUser.phone} onChange={(e) => seteditUser({
                                    ...editUser,
