...
const Work = () => {
    ...
    function handleDone(work_id, work_name, work_dueDate) {
        ...
        axiosData.put(`/api/work/${work_id}`, updateWork);
    }
    const convertToTimeDate = (dueDate) => {
        console.log({ dueDate });
        ...
        <div className="work_in_workspace_container" onClick={hideShowSort}>
                        ...
                        <div className="work_item" id={`work_checkbox${value1.id}`}>
                            <div className="check_box_work">
                                <button
                                    ...
                                    onClick={() => {
                                        handleDone(value1.id, value1.name, value1.due_date);
                                    }}
                                >
                            ...
                            <div className="work_infor">
                                ...
                                <div className="date_work">
                                    <p>{convertToTimeDate(value1.due_date).time + " " + convertToTimeDate(value1.due_date).date}</p>
                                </div>
                            </div>
                            <div className="fix_work_item">
                                <div
                                    className="work_item_edit"
                                    onClick={() => {
                                        handle_showChangeWork(value1.id, value1.name, value1.due_date);
                                    }}
                                >
                                    <div className="hmmm">
                                        <svg width="24" height="24">
                                ...
                                <div
                                    className="work_item_delete"
                                    onClick={() => {
                                        handle_showDeleteWork(value1.id);
                                    }}
                                >
                                    <div className="hmmm">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
                    ...
                    <form method="post" onSubmit={handleAddWork}>
                        ...
                        <div className="form_footer">
                            <div className="Cancel">
                                <button type="reset" onClick={handle_hideFormAddWork}>
                                    Cancel
                                </button>
                            </div>
            ...
            <div className="cover_screen" style={{ display: showFormDeleteWorkspace ? "block" : "none" }} onClick={Handel_HideDelete}>
                <div className="announce_delete_workspace" onClick={handle_prevent_spread}>
                    ...
                    <div className="delete_workspace_footer">
                        <div className="cancel_delete_workspace" onClick={Handel_HideDelete}>
                            <button>Cancel</button>
                        </div>
                        <div className="accept_delete_workspace" onClick={handel_deleteWorkspace}>
            ...
            <div className="cover_screen" style={{ display: showFormDeleteWork ? "block" : "none" }} onClick={Handel_HideDelete}>
                <div className="announce_delete_workspace" onClick={handle_prevent_spread}>
                    ...
                    <div className="ggg2">
                        <p>There is no way to recover a work once it has been deleted.</p>
                    </div>
                    <div className="delete_workspace_footer">
                        <div className="cancel_delete_workspace" onClick={Handel_HideDelete}>
                            <button>Cancel</button>
                    ...
                    <form method="post">
                        ...
                        <div className="button_workspace_rename">
                            <div className="save_rename_workspace">
                                <button type="button" onClick={() => saveEditWorkspace(workspace_id)} className="button_rename_workspace">
                                    Rename
                                </button>
                            </div>
