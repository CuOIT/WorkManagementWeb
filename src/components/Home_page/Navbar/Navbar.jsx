          ...
          <div className="announce_container" style = {{display:show ? "block" : "none"}}>
              <ul>
                {invite?.map((item, index) => {
                  return (
                    ...
                    <div className='content'>
                      <p>{item.inviter} just send you invite to join {item.project_id}</p>
                    </div>
                    <div className='action'>
                        ...
                        <button className='refuse' onClick={() => handleRefuse(item.id)}>
                          <svg viewBox="0 0 24 24" class="icon_close" width="24" height="15"><path fill="currentColor" fill-rule="nonzero" d="M5.146 5.146a.5.5 0 0 1 .708 0L12 11.293l6.146-6.147a.5.5 0 0 1 .638-.057l.07.057a.5.5 0 0 1 0 .708L12.707 12l6.147 6.146a.5.5 0 0 1 .057.638l-.057.07a.5.5 0 0 1-.708 0L12 12.707l-6.146 6.147a.5.5 0 0 1-.638.057l-.07-.057a.5.5 0 0 1 0-.708L11.293 12 5.146 5.854a.5.5 0 0 1-.057-.638z"></path></svg>
                        </button>
                    </div>
                </li>
                  )
                ...
                <li>
                    ...
                    <div className='action' style ={{display:showing ? "none" : "flex"}}>
